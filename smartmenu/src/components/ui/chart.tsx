...
type ChartTooltipValue = number;
type ChartTooltipName = string;
type ChartTooltipItem = RechartsPayload<ChartTooltipValue, ChartTooltipName>;
...
// Tooltip component (wraps Recharts Tooltip)
